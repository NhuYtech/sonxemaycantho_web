            ...
            <button
              ...
              className={`p-4 rounded-xl text-left transition-all ${
                theme === themeOption.value
                  ? "bg-blue-600 border-2 border-blue-500 text-white shadow-[0_0_20px_rgba(249,115,22,0.4)]"
                  : "bg-blue-950/30 border border-blue-900/20 text-gray-300 hover:bg-blue-950/40 hover:border-blue-900/40"
              }`}
            >
