      ...
      <div className="relative w-full max-w-sm bg-[#1A0A00cc] backdrop-blur-md rounded-2xl p-8 shadow-[0_0_40px_rgba(255,60,60,0.4)] border border-red-700">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-500 hover:to-orange-400 text-white font-bold rounded-full py-3 flex items-center justify-center gap-2 transition shadow-[0_0_15px_rgba(255,80,80,0.5)]"
          >
            🔥 ĐĂNG NHẬP
          </button>
